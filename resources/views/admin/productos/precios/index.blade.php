...
@section('title', 'Precios - ' . $producto->nombre)

@section('content_header')
    <h1>
        <b>Precios</b> – {{ $producto->nombre }}
    </h1>
    <br>
...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.productos.precios.create', $producto) }}"
        ...
        <div class="card-body p-0">
            ...
            @if($precios->isEmpty())
                <div class="p-3">
                    <em>No hay precios definidos para este producto.</em>
                </div>
            @else
                        ...
                        @foreach($precios as $precio)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST"
                                        action="{{ route('admin.productos.precios.update', [$producto, $precio]) }}"
                                        class="d-flex gap-2">
                                        @csrf
                                        @method('PUT')
