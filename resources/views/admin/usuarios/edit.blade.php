        ...
        <div class="container">
            ...
            <form action="{{ route('admin.usuarios.update', $user) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="email2" name="email2" value="{{old('email2', $user->email2)}}"> 
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <input type="date" class="form-control" id="fechanacimiento" name="fechanacimiento" value="{{old('fechanacimiento', $user->fechanacimiento)}}"> 
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="empresa" name="empresa" value="{{old('empresa', $user->empresa)}}"> 
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="telefonos" name="telefonos" value="{{old('telefonos', $user->telefonos)}}"> 
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="localidad" name="localidad" value="{{old('localidad', $user->localidad)}}"> 
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="provincia" name="provincia" value="{{old('provincia', $user->provincia)}}"> 
                    </div>
                        ...
                        {{-- <select name="roles" id="roles" class="form-control">
                             <option value="">
                                @forelse($user->roles as $role)
                                    <li>{{ $role->name }}</li>
                                @empty
                                    <li>Seleccionar un Rol</li>
                                @endforelse
                            </option>
                            @foreach ($roles as $rol)
                                <option value="{{ $rol->name }}" {{ request('rol_name') == $rol->name ? 'selected' : '' }}>
                                    {{ $rol->name }}
                                </option>
                            @endforeach
                        </select> --}}
...
{{-- 
                <ul>
                    @forelse($user->roles as $role)
                        <li>{{ $role->name }}</li>
                    @empty
                        <li>Este usuario no tiene roles asignados.</li>
                    @endforelse
                </ul> --}}
                ...
                <div class="card-footer">
                    ...
                    <button type="button" onclick="window.location='{{route('admin.usuarios.index')}}'" class="btn btn-secondary">Volver</button>
                </div>    
            </form>
        </div>
    </div>
